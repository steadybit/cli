...
func newRoot() *cobra.Command {
	...
	root.AddCommand(newAccessToken(), newAdvice(), newConfig(), newEnvironment(), newExecution(), newExperiment(), newSchedule(), newService(), newServiceProfile(), newTeam(), newTemplate(), newUser())
